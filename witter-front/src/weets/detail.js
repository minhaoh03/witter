...
export function Weet(props) {
    ...
    return (
    <div className='grid grid-rows-4 grid-cols-9 rounded-lg border-2 border-gray-300 m-2 w-136 h-32 overflow-hidden' id='weetContainer'>
        ...
        <div id='right' className = 'flex flex-col row-start-1 row-end-4 col-span-7'>
            ...
            <div id='content' className='text-sm justify-items-center text-white'>
                {content}
            </div>
        </div>
